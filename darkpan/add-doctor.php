                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="" method="POST" autocomplete="off"  enctype="multipart/form-data">
                        ...
                        <label>Specialization</label>
                            <select class="form-control" name="splst" value="<?php echo $row['splst']; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="a-days" value="<?php echo $row['days']; ?>">
...

    {
        ...
        $result = mysqli_query($conn, $query1);
            ...
            else
            {
             ...
             VALUES ('{$doc_name}','{$filename}','{$doc_splst}','{$doc_city}','{$doc_timing}','{$doc_a_days}','{$doc_address}','{$doc_role}')";
